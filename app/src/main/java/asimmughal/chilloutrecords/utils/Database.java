    ...
    public RestaurantModel setRestaurants(JSONObject json_data) {
        ...
        try {
            ...
            if (!city_name.isNull("name")) {
                restaurantModel.city_name = city_name.getString("name");
            }
            ...
            if (!area_name.isNull("name")) {
                restaurantModel.city_id = city_id.getString("id");
            }
...
//                        restaurantModel.offer_id = active_offers.getString("id");
//                        restaurantModel.offer_category_id = String.valueOf(OFFER_CATEGORY_ID);
////                        }
//                    }
//                }
//            }
...
//                restaurantModel.offer_collection_id = COLLECTION_ID;
//            }
            ...
            for (int v = 0; v < cuisine_name_array.length(); v++) {
                ...
                if (!cuisine_name.isNull("name")) {
                    restaurantModel.cuisine_name = restaurantModel.cuisine_name.concat(cuisine_name.getString("name").concat(" | "));
                }
            }
